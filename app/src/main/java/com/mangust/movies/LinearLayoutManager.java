...
public class LinearLayoutManager extends android.support.v7.widget.RecyclerView.LayoutManager {
    ...
    public android.support.v7.widget.RecyclerView.LayoutParams generateDefaultLayoutParams() {
        return new android.support.v7.widget.RecyclerView.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
     ...
     * RecyclerView.
     * <p>
     * If you are using a {@link android.support.v7.widget.RecyclerView.RecycledViewPool}, it might be a good idea to set
    ...
    @Override
    public void smoothScrollToPosition(android.support.v7.widget.RecyclerView recyclerView, android.support.v7.widget.RecyclerView.State state,
                                       int position) {
     ...
     */
    void onAnchorReady(android.support.v7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
    }

    /**
     * If necessary, layouts new items for predictive animations
     */
    private void layoutForPredictiveAnimations(android.support.v7.widget.RecyclerView.Recycler recycler,
                                               android.support.v7.widget.RecyclerView.State state, int startOffset, int endOffset) {
        ...
        final List<android.support.v7.widget.RecyclerView.ViewHolder> scrapList = recycler.getScrapList();
        final int scrapSize = scrapList.size();
        final int firstChildPos = getPosition(getChildAt(0));
        for (int i = 0; i < scrapSize; i++) {
            android.support.v7.widget.RecyclerView.ViewHolder scrap = scrapList.get(i);
    ...
    private void updateAnchorInfoForLayout(android.support.v7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
     ...
     */
    private boolean updateAnchorFromChildren(android.support.v7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (getChildCount() == 0) {
            return false;
        }
     ...
     */
    private boolean updateAnchorFromPendingData(android.support.v7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (state.isPreLayout() || mPendingScrollPosition == NO_POSITION) {
            return false;
        }
     ...
     */
    private int fixLayoutEndGap(int endOffset, android.support.v7.widget.RecyclerView.Recycler recycler,
                                android.support.v7.widget.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     * @return The final offset amount for children
     */
    private int fixLayoutStartGap(int startOffset, android.support.v7.widget.RecyclerView.Recycler recycler,
                                  android.support.v7.widget.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     */
    @Override
    public int scrollHorizontallyBy(int dx, android.support.v7.widget.RecyclerView.Recycler recycler,
     ...
     */
    @Override
    public int scrollVerticallyBy(int dy, android.support.v7.widget.RecyclerView.Recycler recycler,
                                  android.support.v7.widget.RecyclerView.State state) {
        if (mOrientation == HORIZONTAL) {
            return 0;
        }
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace,
                                   boolean canUseExistingSpace, android.support.v7.widget.RecyclerView.State state) {
    ...
    int scrollBy(int dy, android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
     ...
     */
    private void recycleChildren(android.support.v7.widget.RecyclerView.Recycler recycler, int startIndex, int endIndex) {
     ...
     *                 moving them.
     */
    private void recycleViewsFromStart(android.support.v7.widget.RecyclerView.Recycler recycler, int dt) {
        if (dt < 0) {
            if (DEBUG) {
     ...
     */
    private void recycleViewsFromEnd(android.support.v7.widget.RecyclerView.Recycler recycler, int dt) {
        final int childCount = getChildCount();
        if (dt < 0) {
            if (DEBUG) {
     ...
     */
    private void recycleByLayoutState(android.support.v7.widget.RecyclerView.Recycler recycler, LayoutState layoutState) {
    ...
    void layoutChunk(android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state,
        ...
        android.support.v7.widget.RecyclerView.LayoutParams params = (android.support.v7.widget.RecyclerView.LayoutParams) view.getLayoutParams();
     ...
     */
    private View findReferenceChildClosestToEnd(android.support.v7.widget.RecyclerView.State state) {
     ...
     * @return A View that can be used an an anchor View.
     */
    private View findReferenceChildClosestToStart(android.support.v7.widget.RecyclerView.State state) {
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
                                    android.support.v7.widget.RecyclerView.Recycler recycler, android.support.v7.widget.RecyclerView.State state) {
        resolveShouldLayoutReverse();
        if (getChildCount() == 0) {
            return null;
        }
    ...
    static class LayoutState {
        ...
        /**
         * Equal to {@link android.support.v7.widget.RecyclerView.State#isPreLayout()}. When consuming scrap, if this value
         ...
         */
        List<android.support.v7.widget.RecyclerView.ViewHolder> mScrapList = null;

        /**
         * @return true if there are more items in the data adapter
         */
        boolean hasMore(android.support.v7.widget.RecyclerView.State state) {
        ...
        private View nextFromLimitedList() {
            ...
            android.support.v7.widget.RecyclerView.ViewHolder closest = null;
            int closestDistance = Integer.MAX_VALUE;
            for (int i = 0; i < size; i++) {
                android.support.v7.widget.RecyclerView.ViewHolder viewHolder = mScrapList.get(i);
    ...
    class AnchorInfo {
         ...
         * child.
         */
        public boolean assignFromViewIfValid(View child, android.support.v7.widget.RecyclerView.State state) {
